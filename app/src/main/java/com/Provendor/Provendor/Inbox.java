...
private int unreadMessages;
    ...
    public void checkedinbox(){unreadInbox=0;}
    @PropertyName("unreadMessages")
    public int getUnreadMessages() {return unreadMessages;}
    @PropertyName("unreadInbox")
    public int getUnreadInbox() {return unreadInbox;}

    // Setters
    public void setUnreadInbox(int unreadInbox) {this.unreadInbox = unreadInbox;}
